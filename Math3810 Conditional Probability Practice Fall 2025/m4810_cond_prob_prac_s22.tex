...
\vskip 2mm
Consider the random experiment $\epsilon$ of selecting a random family having two children and recording whether they are boys or girls.
	\end{boxsolution}
	\begin{boxsolutioncont}
Then
...
Now, we know that $\P(F) = 4/36$, $\P(G) = 6/36$, and $\P(H) = 26/36$. Also, given that the first roll is a 5, the probability
we get a 5 before a 7 is 1: $\P(E\,|\,F) = 1$. Similarly, given that the first roll is a 7, the probability we get a 5 before a 7 is 0:
...
HTH, THH, HTT, THT, TTH\}$. $\P\big(A\cap B\big) = 1/8 = (2/8)(4/8) = \P(A)\cdot\P(B)$, so $A$ and $B$ are independent. $P(A\cap C) =
1/8 6= (2/8)(7/8) = \P(A)\cdot\P(C)$, so $A$ and $C$ are dependent. $\P(B\cap C) = 4/8 6= (4/8)(7/8) = \P(B)\cdot\P(C)$, so $B$ and
$C$ are dependent.		
\vskip 2mm		
	\end{boxsolution}
